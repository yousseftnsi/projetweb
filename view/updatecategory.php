...
foreach($prod as $pro){
?>
                        <form action="updatecategoryFct.php" method="POST" enctype="multipart/form-data">
                           <div class="form-group">
                            
                                        <input type="hidden" name="id_category" value="<?php echo $pro['id_category'] ?>">
                                        <label for="titre">Nom</label>
                                       <input type="text" class="form-control" id="titre" placeholder="titre" name="titre" value="<?php echo $pro['titre'] ?>">
                                       </div>
